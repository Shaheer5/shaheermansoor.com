...
const siteMetadata = {
  ...
  x: 'https://twitter.com/ShaheerMansoor2',
  // twitter: 'https://twitter.com/Twitter',
  facebook: 'https://www.facebook.com/shaheer.mansoor.35',
  ...
  newsletter: {
    ...
    emailOctopusConfig: {
      // Add your EmailOctopus API key and list ID here
  ...
  comments: {
    ...
    disqusConfig: {
      // Visit https://disqus.com/ to get your shortname
